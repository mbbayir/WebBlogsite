...
$(document).ready(function() {
    ...
    $(document).ready(function() {
        ...
        var btnDownloadCV = document.querySelector('.btn-download-cv');
        btnDownloadCV.addEventListener('mouseenter', function() {
            anime({
                targets: '.btn-download-cv',
                scale: 1.05,
                duration: 300,
                easing: 'easeInOutQuad'
            });
        ...
        btnDownloadCV.addEventListener('mouseleave', function() {
            anime({
                targets: '.btn-download-cv',
                scale: 1,
                duration: 300,
